...
class Lab10_4 extends StatelessWidget {
  const Lab10_4({super.key});
          ...
          child: Column(
            ...
            children: [
              ...
              ElevatedButton(
                ...
                child: Text(isRegisterScreen ? 'Register' : 'Login'),
              ),
              SizedBox(height: 20),
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Text(isRegisterScreen ? 'Already have an account?' : 'Don\'t have an account?'),
                  SizedBox(width: 5),
                  InkWell(
                    onTap: () {
                      setState(() {
                        isRegisterScreen = !isRegisterScreen;
                        loginText = isRegisterScreen ? 'Register' : 'Login';
                        registerText = isRegisterScreen ? 'Login' : 'Register';
                      });
                    },
                    child: Text(
